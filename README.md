...
**PC 마우스와 키보드 하나로 Android와 다른 Windows PC까지 제어하는 로컬 네트워크 도구**

마우스를 화면 끝으로 넘기면 커서가 폰이나 옆 PC로 이어지고, 키보드 입력·파일·클립보드도 그대로 따라갑니다. 같은 Wi-Fi(공유기) 안에서 동작하며, 복잡한 네트워크 설정은 필요 없습니다.

> OneMouse lets you control your Android phone and other Windows PCs with a single mouse and keyboard over your local network — including file transfer, clipboard sync, and remote screen control. [English site](https://onemouse.pages.dev/en/)
