...
**Windows 마우스와 키보드 하나로 Android와 다른 Windows PC를 제어하고, Mac 보조 지원을 준비 중인 로컬 연결 도구**

마우스를 화면 끝으로 넘기면 커서가 폰이나 옆 Windows PC로 이어지고 키보드 입력·파일·클립보드도 따라갑니다. macOS 13+ 보조 앱은 소스 구현 후 서명·공증 배포와 실기기 검증을 준비 중입니다.

> OneMouse lets a Windows PC control Android and another Windows PC. macOS 13+ secondary-device support is awaiting signed distribution and real-Mac validation. [English site](https://onemouse.pages.dev/en/)
...
- **Windows-to-Mac 제어 준비** — macOS 13+ 보조 전용 소스는 구현됐으며 입력·파일·경계 드래그·화면 공유·Bluetooth 실기기 검증과 배포가 남아 있습니다.
...
1. Windows 메인 앱과 macOS 13+ Mac 앱을 실행합니다.
...
| macOS 13+ | 보조 기기 앱 · 서명/공증 배포 준비 중 |
